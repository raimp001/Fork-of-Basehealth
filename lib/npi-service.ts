...
// Export both the default export and named functions for compatibility
export default npiService

// Also export the searchNPIProviders function for direct use
export const searchNPIProviders = npiService.searchNpiRegistry
