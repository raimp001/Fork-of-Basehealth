    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-50 via-white to-stone-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 pt-24">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-stone-900 mb-4 tracking-tight">Settings</h1>
          <p className="text-lg text-stone-600 leading-relaxed">Manage your account and preferences</p>
        </div>
