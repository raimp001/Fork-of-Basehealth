...
export default function InsuranceAnalyticsPage() {
  ...
  const loadAnalytics = async () => {
    try {
      ...
      const data = await getPatientAnalytics(address)
      setAnalytics(data)
    } catch (error) {
    ...
    return (
      <div className="max-w-4xl mx-auto py-12 px-4">
        <div className="text-center">
          <h1 className="text-3xl font-bold mb-6">Insurance Analytics</h1>
    ...
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <Card className="p-4">
          ...
          <p className="text-2xl font-bold">{analytics.rejectedClaims}</p>
        </Card>
      </div>
